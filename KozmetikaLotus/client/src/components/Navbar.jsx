    ...
    return (
      <div className="navbar-wrapper flex flex-col w-[100%]">
        <div className="pages-navbar flex justify-between bg-[#FFFFFF] pr-10 md:px-[9%] w-[100%]  p-4 pb-8">
          <div>
            <div
              className="absolute top-2 md:top-4 cursor-pointer"
              onClick={() => navigate("/")}
            >
              <LotusLogo />
            </div>
          ...
          <div className=" hidden md:flex mt-1 -mb-3 justify-between items-center relative">
            ...
            {currentUser && (
              <div
                onClick={navWishList}
                className="relative wishlist flex items-center p-2 pr-4 -ml-6 mb-[3px] cursor-pointer"
              >
                <FaRegHeart size={22} />
                <span className="text-xs absolute right-0 top-0 transform translate-x-50% -translate-y-50% text-white bg-red-700 font-semibold rounded-full pr-1 p-1">
                  {wishlistLength && wishlistLength > 0 ? wishlistLength : "0"}
                </span>
              </div>
            )}
            ...
            <div
              ...
              className="relative p-2 pr-4 hover:cursor-pointer"
            >
              <IoCartOutline size={25} />
              <span className="text-xs absolute top-0 right-[0] transform translate-x-50% -translate-y-50% text-white bg-red-700 font-semibold rounded-full p-1">
                    ...
                    <div className="w-[90%] justify-center">
                      <div className="test flex justify-center flex-col items-center">
                        <div className="mt-4 text-start items-start align-middle w-full pb-4">
                          {currentUser ? (
                            <div>
                              <h2 className="text-[#101817] text-lg font-semibold mb-1">
                                My Profile
                              </h2>
                              <div
                                onClick={navProfile}
                                className="profile flex items-center border rounded-lg p-2 mb-1 cursor-pointer border-[#A2A2A2]"
                              >
                                <FaRegUserCircle size={20} />
                                <h2 className="ml-3 text-[#101817] w-[100%] text-sm font-semibold ">
                                  Account Information
                                </h2>
                              </div>
                            ...
                            <div
                              ...
                              className="profile flex items-center border rounded-lg p-2 cursor-pointer border-[#A2A2A2]"
                            >
                              <FaRegUserCircle size={20} />
                              <h2 className="ml-3 text-[#101817] w-[100%] text-sm font-semibold ">
                                Log In
          ...
          <div className="flex md:hidden">
            ...
            <div
              onClick={handleNav}
              className="block md:hidden mt-1 -mb-3 cursor-pointer"
            >
              {nav ? (
                <AiOutlineClose size={25} color="#292929" />
              ) : (
                <AiOutlineMenu size={25} color="#292929" />
              )}
            </div>
          </div>
          ...
          <div
            className={
              nav
                ? "z-50 fixed overflow-auto  left-0 top-0 w-[100%] block md:hidden border-r h-full bg-[#FFFFFF] ease-in-out duration-500"
                : "fixed left-[-100%]"
            }
          >
            ...
            <div className="categories mt-3 ml-3 overflow-auto">
              <h1 className="text-[#292929] text-sm font-semibold p-4 w-[95%] border-b border-[#DFDFDF]">
                Categories
              </h1>
              <div>
                <h2
                ...
                {categories.map((category) => (
                  <div
                    key={category.name}
                    className="m-2 relative text-[#292929]"
                  >
              ...
              <ul className="p-4">
                {currentUser ? (
                  <div>
                    <div
                      onClick={navProfile}
                      className="profile flex items-center p-3 mb-2 border-b border-[#DFDFDF]"
                    >
                      <FaRegUserCircle size={20} />
                      <h2 className="ml-3 text-[#101817] w-[100%] text-md font-semibold ">
                        Account Information
                      </h2>
                    </div>
                    {/* Shopping cart icon */}
                    ...
                    >
                      <IoCartOutline size={25} />
                      <span className="text-xs top-0 mb-5 right-[0] transform translate-x-50% -translate-y-50% text-white bg-red-700 font-semibold rounded-full p-1">
                        {cart.length > 0 ? cart.length : "0"}
                      </span>
                      <h2 className="ml-3 text-[#101817] w-[100%] text-md font-semibold ">
                        Shopping Cart
                    ...
                    <div
                      onClick={navWishList}
                      className="wishlist flex items-center p-3 mb-2 border-b border-[#DFDFDF]"
                    >
                      <FaRegHeart size={20} />
                      <h2 className=" ml-3 text-[#101817] w-[100%] text-md font-semibold ">
                        My Wishlist
                    ...
                    {user.role === "admin" && (
                      <div
                        ...
                        className="wishlist flex items-center p-3 mb-2 border-b border-[#DFDFDF]"
                      >
                        <h2 className="text-[#101817] w-[100%] text-md font-semibold">
                          Admin
                        </h2>
                      </div>
                    )}
                    <li
                      className="p-3 font-semibold text-red-700 border-b border-[#DFDFDF]"
                      onClick={logout}
                    >
                      <a href="/">Log out</a>
                    </li>
                  ...
                  <div>
                    ...
                    <div
                      onClick={() => navigate("/login")}
                      className="profile flex items-center p-3 mb-2 cursor-pointer border-b border-[#DFDFDF]"
                    >
                      <FaRegUserCircle size={20} />
                      <h2 className="ml-3 text-[#101817] w-[100%] text-md font-semibold ">
                        Log In
