    ...
    return (
      <div>
        <div className='relative flex items-center md:p-2 md:pr-4 md:-ml-6 md:end-1 md:mb-[3px] cursor-pointer'>
          ...
          {searchModal && 
            <div className='modal rounded-2xl absolute top-20 left-50 right-50 bg-[#FAF9F5] shadow-lg w-[300px] px-4' // Close modal when not hovering
                  ...
                  <div className='test flex justify-center flex-col items-center'>
                    <div className='mt-4 text-start items-start align-middle w-full pb-4'>
                      <div className='flex flex-col border-[0.5px] border-x-0 border-t-0 border-gray-500'>
                          <h2 className='text-gray-500 font-semibold'>Rezultatet:</h2>
                        {/* Product cart */}
                        {products.map((product, index) => (
                          <div key={index} className='border-[0.5px] border-x-0 border-b-0 py-1 m-1 border-gray-500' onClick={() => onClickProduct(product)}>
